const TRADUCOES: Array<[string, string]> = [
  ...
  ["Email rate limit exceeded", "Muitos emails enviados em pouco tempo. Espera um pouco e tenta de novo, ou entre em contato com o administrador."],
  ["over_email_send_rate_limit", "Muitos emails enviados em pouco tempo. Espera um pouco e tenta de novo, ou entre em contato com o administrador."],
